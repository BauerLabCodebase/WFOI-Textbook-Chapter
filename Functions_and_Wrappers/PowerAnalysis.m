function [whole_spectra_map,... Each pixel has a power spectra
    avg_cort_spec,...    %Average over all of the pixels
    powerMap,hz,...                 integrated spectra for each pixel (size 128,128)
...
if numel(varargin) > 0
    ...
    fft_bool=varargin{2};% Xiaodan Add %
else %DEFAULT SETTINGS!
    freqRange={[0.01,0.08],[0.5 ,4],[0 10]}; %this function runs for 3 frequency bands
